...
window.featureConfigs = {
    autoAnswerDelay: 3,
    customUsername: "zbloody on top.",
    customPfp: "https://cdn.discordapp.com/attachments/1407728104494989362/1415871351658512465/d9ab9a5a486730db3f8aef1f6f43b209.jpg?ex=68c4c873&is=68c376f3&hm=78480acf29ee659ffdcc36ac9270a463b40fc1efcbf54a2b0c14f079f69559fb&"
};
...
/* Inject */
if (!/^https?:\/\/([a-z0-9-]+\.)?khanacademy\.org/.test(window.location.href)) { alert("❌ Khanvulv Failed to Injected!\n\nVocê precisa executar o Khanvulv no site do Khan Academy! (https://pt.khanacademy.org/)"); window.location.href = "https://pt.khanacademy.org/"; }
...
.then(async () => {
    ...
    sendToast("🚬 Khanvulv injetado com sucesso!");
