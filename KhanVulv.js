...
.then(async () => {
    ...
    sendToast("🧟‍♂️ KhanVulv injetado com sucesso!");
    ...
    if(device.apple) { await delay(500); sendToast(`KhanVulv by 1nsta 🫩`); }
    
    loadedPlugins.forEach(plugin => sendToast(`🧟‍♂️ ${plugin} Loaded!`, 2000, 'top') );
